...
class springProperty{
  ...
  void render(){
    ...
    for(int i = 0; i < 11; i++){
      ...
      else if(i==4) write("内径", SP.iD, "mm", indent_l, indent_h);
      else if(i==5) write("平均径", SP.D, "mm", indent_l, indent_h);
      else if(i==6) write("外径", SP.oD, "mm", indent_l, indent_h);
      else if(i==7) write("自由長", SP.L, "mm", indent_l, indent_h);
      else if(i==8) write("第一加重", SP.P1, "kgf", indent_l, indent_h);
      else if(i==9) write("バネ定数", SP.k, "kgf/mm", indent_l, indent_h);
      else if(i==10) write("バネ指数", SP.c, "--", indent_l, indent_h);
    }
